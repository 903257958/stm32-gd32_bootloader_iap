...
static uint8_t uart_console_tx_buf[512];
...
{
    uart_console_dev.ops->vprintf(&uart_console_dev, format, args);
}
 ...
 * @return  指向操作函数接口表的指针
 */
void *bsp_console_get_esp8266_log_ops(void)
{
    return (void *)&esp8266_log_ops;
}
