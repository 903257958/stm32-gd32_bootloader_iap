...
UARTDev_t uart4 = {.config = {UART4, 921600, GPIOC, GPIO_Pin_10, GPIOC, GPIO_Pin_11}};
UARTDev_t uart5 = {.config = {UART5, 921600, GPIOC, GPIO_Pin_12, GPIOD, GPIO_Pin_2}};
UARTDev_t uart6 = {.config = {USART6, 921600, GPIOC, GPIO_Pin_6, GPIOC, GPIO_Pin_7}};
